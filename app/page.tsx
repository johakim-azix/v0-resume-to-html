          ...
          <div className="header">
            <div className="header-left">
              ...
              <div className="contact-info">
                ...
                <span>+237655715705</span>
                
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                  <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path>
                </svg>
                <a href="mailto:jp.joseph.penda@gmail.com">jp.joseph.penda@gmail.com</a>
                
                <svg className="contact-icon" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
                </svg>
                <a href="https://www.linkedin.com/in/joseph-penda-051a11a7/" target="_blank" rel="noopener noreferrer">linkedin</a>
              </div>
              <div className="contact-info" style={{ marginTop: '8px', gap: 0 }}>Douala, Cameroon</div>
            </div>
            <div className="header-photo">
              <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-23%20at%2012.19.41%20AM-DZgsSC2j5bBJ5YjhJRCIFUFlWkX2y7.jpeg" alt="Joseph Penda" />
            </div>
          </div>
